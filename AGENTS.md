...
- Use `-profile local_containers --module resistance` for the resistance fixture. The module accepts either the committed `assets/hcv_geno2pheno_rules.csv` table or a normalized JSON rules artifact from `scripts/update_geno2pheno_rules.py`.
